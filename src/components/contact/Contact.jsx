...
const Contact = () => {
  ...
  //   {
  //     site : "Linkedin",
  //     link : "https://www.linkedin.com/in/joshilagubbala/",
  //   },
  //   {
  //     site : "Github",
  //     link : "https://github.com/Joshila117",
  //   },
  // ]
            ...
            <nav aria-label="main mailbox folders">
              <List>
                <ListItem disablePadding  className="contact-list-item">
                  <ListItemButton  href="https://www.linkedin.com/in/joshilagubbala/" target="_blank">
                    <ListItemIcon>
                ...
                <ListItem disablePadding className="contact-list-item">
                  <ListItemButton href="https://github.com/Joshila117" target="_blank">
                    <ListItemIcon>
                ...
                <ListItem disablePadding className="contact-list-item">
                  <ListItemButton
                    onClick={() =>
                      (window.location = "mailto:joshila117@gmail.com")
                    }
                  >
                    <ListItemIcon>
                    ...
                    <ListItemText
                      primary="Mail (joshila117@gmail.com)"
